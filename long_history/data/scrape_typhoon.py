...
long_history/data/raw/typhoons.csv with one row per affected DATE (not per signal-period).
...
Output schema (long_history/data/raw/typhoons.csv):
    date         ISO YYYY-MM-DD
...
HERE = Path(__file__).resolve().parent      # long_history/data
DATA_TYPHOONS = HERE / "raw" / "typhoons.csv"
